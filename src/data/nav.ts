    ...
    children: [
      {
        label: "The Parish",
        to: "/about",
        description: "Vision, SS.CC fathers, and a Eucharistic household.",
      },
      {
        label: "Our History",
        to: "/history",
        description: "From Damien Hall in 1963 to the Tent of Meeting restored.",
      },
      {
        label: "FAQ",
        to: "/faq",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description: "Reconciliation, the chapel, and Sacred Heart devotion.",
      },
      {
        label: "Find Us",
        to: "/worship#visit",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description: "Catechesis, RCIA, and lifelong formation.",
      },
      {
        label: "Pastoral Care",
