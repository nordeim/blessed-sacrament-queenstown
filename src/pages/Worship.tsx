    ...
    <>
        ...
        <Container>
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            <MassCard
              dayKey="weekdays"
              title="Weekdays"
              footnote="On public holidays there is only the 8.30 a.m. Mass."
            >
            ...
            <MassCard
              dayKey="saturday"
              title="Saturday"
              footnote="Tamil Mass is celebrated on the 3rd Saturday only, at 7.30 p.m."
              delay={80}
            >
              <p className="mt-3 text-sm leading-relaxed text-shrine-charcoal/85">
                {site.mass.saturday}
            ...
            <MassCard
              dayKey="sunday"
              title="Sunday"
              footnote="Indonesian: last Sunday. Tagalog is English on the 3rd Sunday."
              delay={160}
            >
      ...
      <section id="visit" className="scroll-mt-28 bg-shrine-cream py-20 sm:py-28">
        <Container>
          <SectionHeading
            eyebrow="Find us"
            title="Along Commonwealth Drive"
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
            <div className="space-y-5 text-shrine-charcoal/85">
              ...
              <p>
                The church faces Commonwealth Drive along Queensway, beside Sri Muneeswaran Temple.
                Compound parking is limited; public car parks are a short walk away.
              </p>
              <p>
              ...
              <p>
                Phone {site.contact.officePhone}. WhatsApp during office hours:{" "}
                {site.contact.whatsappHotline}.
              </p>
            ...
            <div className="overflow-hidden rounded-sm border border-shrine-stone shadow-shrine">
              <iframe
                title="Map of Blessed Sacrament Church"
